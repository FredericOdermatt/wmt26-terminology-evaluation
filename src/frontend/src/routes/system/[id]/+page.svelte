...
{:else if system}
  <h1 class="mb-1 text-2xl font-bold">{system.name}</h1>
        ...
        {#if evaluation}
          <div class="mb-2 flex items-center gap-3 text-sm">
            ...
            {#if evaluation.status === "RUNNING"}
              <progress class="progress progress-primary w-56" value={evaluation.percentage} max="100"></progress>
              <span class="opacity-70">{evaluation.percentage}% ({evaluation.stage})</span>
